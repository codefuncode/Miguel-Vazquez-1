...
// Verífica sis existe una Cooke  y además
// establece variables de inicio de sesión
    ...
    <form action="inicio.php" method="post">
      ...
      <div class="container" style="background-color:#f1f1f1">
        <button class="cancelbtn" type="button">
          <a href="registro.php">
            <!--
              Botón en el cual el usuario pueda entrar a una página en donde pueda hacerse una cuenta.
            -->
            Registrase
          </a>
        </button>
